...
interface FileEditorPanelProps {
  ...
  onFileHistoryClick?: (filePath: string) => void;
}
    ...
    >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          {onFileHistoryClick && (
            <Button
              ...
              onClick={() => onFileHistoryClick(filePath)}
              size="small"
            >
              File History
            </Button>
      ...
      {viewMode === "blame" && (
        ...
        >
          <InfoCircleOutlined />
          <span>
            Git Blame shows who last modified each line and when. Click on
            commit hash to see details.
          </span>
        </div>
      )}
