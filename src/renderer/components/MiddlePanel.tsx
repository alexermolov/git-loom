      ...
      case 'reflog':
        return (
          <div className="middle-panel-content">
            ...
            <div className="middle-panel-info" style={{ padding: '20px', maxWidth: '800px' }}>
              <h3 style={{ marginTop: 0, color: 'var(--primary-color)' }}>What is Git Reflog?</h3>
              <p>
                <strong>Reflog</strong> (reference log) is Git's safety net that records every movement of HEAD and branch tips. 
                It tracks all changes including commits, checkouts, merges, resets, and rebases.
              </p>

              <h3 style={{ color: 'var(--primary-color)' }}>Key Features</h3>
              <ul style={{ lineHeight: '1.8' }}>
                <li><strong>Safety Net:</strong> Recover "lost" commits, undo mistakes, and restore deleted branches</li>
                <li><strong>Local History:</strong> View all repository state changes in chronological order</li>
                <li><strong>Time Travel:</strong> Jump to any previous state using <code>HEAD@{'{n}'}</code> syntax</li>
                <li><strong>Audit Trail:</strong> Track who made changes and when</li>
              </ul>

              <h3 style={{ color: 'var(--primary-color)' }}>Common Use Cases</h3>
              <div style={{ marginBottom: '12px' }}>
                <strong>🔄 Undo a Hard Reset:</strong>
                <p style={{ marginLeft: '20px', color: 'var(--text-secondary)' }}>
                  Accidentally ran <code>git reset --hard</code>? Find the commit before reset in reflog and restore it.
                </p>
              </div>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <p style={{ marginLeft: '20px', color: 'var(--text-secondary)' }}>
                  Deleted a branch by mistake? Reflog shows the last commit on that branch.
                </p>
              </div>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <p style={{ marginLeft: '20px', color: 'var(--text-secondary)' }}>
                  Rebase went wrong? Find the state before rebase started and reset to it.
                </p>
              </div>
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <p style={{ marginLeft: '20px', color: 'var(--text-secondary)' }}>
                  Understand what operations were performed on the repository over time.
                </p>
              </div>

              <h3 style={{ color: 'var(--primary-color)' }}>Reference Syntax</h3>
              <ul style={{ lineHeight: '1.8', fontFamily: 'monospace', fontSize: '13px' }}>
                <li><code>HEAD@{'{0}'}</code> - Current HEAD position (most recent)</li>
                <li><code>HEAD@{'{1}'}</code> - Previous HEAD position</li>
                <li><code>HEAD@{'{2.hours.ago}'}</code> - HEAD position 2 hours ago</li>
                <li><code>master@{'{yesterday}'}</code> - Master branch position yesterday</li>
              </ul>
              ...
              <div style={{ 
                ...
                <ul style={{ margin: 0, paddingLeft: '20px' }}>
                  <li>Reflog is <strong>local only</strong> - not shared with other clones</li>
                  <li>Entries expire after <strong>90 days</strong> by default (configurable)</li>
                  <li>Unreachable commits are garbage collected after expiration</li>
                  <li>Each clone has its own independent reflog</li>
                </ul>
              </div>

              <h3 style={{ color: 'var(--primary-color)', marginTop: '20px' }}>Actions Available</h3>
              <p>
                Use the dropdown menu (⋮) on each reflog entry to:
              </p>
              <ul style={{ lineHeight: '1.8' }}>
                <li><strong>View Details:</strong> See commit content and changes</li>
                <li><strong>Cherry-pick:</strong> Apply this commit to current branch</li>
                <li><strong>Reset (Soft):</strong> Move HEAD but keep changes staged</li>
                <li><strong>Reset (Mixed):</strong> Move HEAD and unstage changes</li>
                <li><strong>Reset (Hard):</strong> Move HEAD and discard all changes</li>
                <li><strong>Copy Hash:</strong> Copy commit SHA to clipboard</li>
              </ul>
            </div>
          </div>
        );
